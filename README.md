...
5. **Change the context** from "top" to "app_zentune" (or the exact name of your application) using the dropdown at the top of the console
   ...
   <img src="assets/Step1.png" alt="Step 1: Find the 'top' dropdown" width="350" />
   
   <img src="assets/Step2.png" alt="Step 2: Select 'app_zentune' from dropdown" width="350" />
...
6. **Type the following command** and press Enter:
   ...
   <img src="assets/Step3.png" alt="Step 3: Enter getRedirectUri() command and copy the result" width="350" />
